...
#
        ...
        response = requests.get("http://rocket:3000/api/v1/channels.messages?roomName=general", headers=headers)
...
class DetailsForm(FormAction):
    ...
    def required_slots(tracker):
            return ["email","phno","firstname","lastname"]
    ...
    def submit(
        ...
        domain: Dict[Text, Any],
         ...
         val = tracker.get_slot("email")
         dispatcher.utter_message("email is {}".format(val))
         print(val)
         return []
